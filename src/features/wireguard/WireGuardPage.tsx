...
export default function WireGuardPage() {
  ...
  return (
    <PageLayout title="WireGuard" subtitle="Клиенты входят на utils и выходят через AmneziaWG на Veesp" actions={<><Button icon={<ReloadOutlined />} onClick={() => void loadRelays()}>Обновить</Button><Button type="primary" icon={<PlusOutlined />} onClick={() => setCreateRelayOpen(true)}>Новый relay</Button></>}>
